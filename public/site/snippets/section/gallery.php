				...
				<div class="swiper-slide">
					<div class="Slider__item">
						<div class="Slider__crop">
							...
							<span class="Slider__icon--zoom"><svg version="1.2" baseProfile="tiny" id="slider-icon--zoom" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
				...
				<?php foreach($slides as $key => $slide): ?>
					<div class="swiper-slide">
						<div class="Slider__item">
							...
							<?php else : ?>
								<div class="Slider__crop<?php if($slide->image()->isPortrait()) echo ' Slider__crop--portrait' ?>">
									<img src="<?= thumb($slide->image()->toFile(), array('width' => 1600, 'height' => 900, 'crop' => false))->url(); ?>" />
								</div>
							<?php endif; ?>
						</div>
